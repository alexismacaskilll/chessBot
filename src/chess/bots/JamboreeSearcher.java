...
public class JamboreeSearcher<M extends Move<M>, B extends Board<M, B>> extends
    ...
    public M getBestMove(B board, int myTime, int opTime) {
    	int cutOff = cutoff;
    	BestMove<M> best = jamboree(this.evaluator, board, ply, Integer.MIN_VALUE + 1, Integer.MAX_VALUE, cutOff);
        return best.move;
    }
    
    static <M extends Move<M>, B extends Board<M, B>> BestMove<M> jamboree(Evaluator<B> evaluator, B board, int depth, int alpha, int beta, int cut) {
