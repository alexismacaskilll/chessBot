...
public class ParallelSearcher<M extends Move<M>, B extends Board<M, B>> extends
    ...
    public M getBestMove(B board, int myTime, int opTime) {
    	int cutOff = cutoff;
    	return minimax(this.evaluator, board, ply, cutOff, POOL).move;
    }
    ...
    public static <M extends Move<M>, B extends Board<M, B>> BestMove<M> minimax(Evaluator<B> evaluator, B board, int depth, int cut, ForkJoinPool pool) {
